                        ...
                        {menuOpen && (
                            ...
                            >
                                ...
                                <nav className="flex flex-col gap-4">
                                    <Link to="/user/teacher/dashboard" className="text-gray-800 dark:text-white hover:underline">
                                        Dashboard
                                    </Link>
                                    <Link to="/user/teacher/profile" className="text-gray-800 dark:text-white hover:underline">
                                        Profile
                                    </Link>
                                    <Link to="/user/teacher/misses" className="text-gray-800 dark:text-white hover:underline">
                                        Misses
                                    </Link>
                                    <Link to="/user/teacher/code-editor" className="text-gray-800 dark:text-white hover:underline">
                                        Code Editor
                                    </Link>
                                    <Link to="/user/teacher/quiz" className="text-gray-800 dark:text-white hover:underline">
                                        Quiz
                                    </Link>
                                    <button
                                        onClick={toggleDarkMode}
